                ...
                <div class="col-md-8">
                    <form action="{{ url('userhomepage/update') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control w-90 @error('username') is-invalid @enderror" name="username" id="username" required value="{{ $user->username }}">
                                @error('judul')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control w-90 @error('name') is-invalid @enderror" name="name" id="name" required value="{{ $user->name }}">
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control w-90 @error('nomor_Telp') is-invalid @enderror" name="nomor_Telp" id="nomor_Telp" required value="{{ $user->nomor_Telp }}">
                                @error('nomor_Telp')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control w-90 @error('email') is-invalid @enderror" name="email" id="email" required value="{{ $user->email }}">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control w-90 @error('alamat') is-invalid @enderror" name="alamat" id="nomor_Telp" required value="{{ $user->alamat }}">
                                @error('alamat')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
